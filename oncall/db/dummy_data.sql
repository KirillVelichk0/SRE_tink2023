...
INSERT INTO `user` VALUES
    ...
    (5, 'test_user', 1, 'test_user', NULL, NULL, 0);
...
INSERT INTO `team`(`id`,`name`,`slack_channel`, `slack_channel_notifications`, `email`,`scheduling_timezone`,
  `active`, `iris_plan`, `iris_enabled`, `override_phone_number`)
 VALUES (1,'Test Team','#team','#team-alerts','team@example.com','US/Pacific',1,NULL,0,NULL);
...
INSERT INTO `application` (`name`,`key`)
VALUES ('test_app','test_key');
UNLOCK TABLES;
